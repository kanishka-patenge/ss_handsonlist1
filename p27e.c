...
int main()
{
    ...
    printf("Using the execvp() to execute ls -Rl \n");
    char *file = "ls";
    char *args[] = {file,arg1,NULL};
    execvp(file,args);
...
kanishka@kanishka-HP-Laptop-15s-fq5xxx:~/abc$ gcc p27e.c
kanishka@kanishka-HP-Laptop-15s-fq5xxx:~/abc$ ./a.out
Using the execvp() to execute ls -Rl 
.:
total 584
...
-rwxrwxr-x 1 kanishka kanishka 16056 Aug 29 19:39 a.out
...
-rw-rw-r-- 1 kanishka kanishka  7540 Aug 29 19:36 p27c.c
-rw-rw-r-- 1 kanishka kanishka  7563 Aug 29 19:38 p27d.c
-rw-rw-r-- 1 kanishka kanishka   871 Aug 29 19:39 p27e.c

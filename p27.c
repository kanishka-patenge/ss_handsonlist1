...
int main()
{
    printf("Using the execl() to execute ls -Rl \n");
    char *path = "/bin/ls";
    char *arg1 = "-Rl";
    char *cmd = "ls";
    execl(path,cmd,arg1,NULL);
    
    printf("Using the execlp() to execute ls -Rl \n");
    char *file = "ls";
...
kanishka@kanishka-HP-Laptop-15s-fq5xxx:~/abc$ gcc p27.c
kanishka@kanishka-HP-Laptop-15s-fq5xxx:~/abc$ ./a.out
Using the execl() to execute ls -Rl 
.:
total 568
...
-rwxrwxr-x 1 kanishka kanishka 16000 Aug 29 19:32 a.out
...
-rw-rw-r-- 1 kanishka kanishka   376 Aug 28 07:41 p27b.c
-rw-rw-r-- 1 kanishka kanishka   862 Aug 29 19:31 p27.c
-rw-rw-r-- 1 kanishka kanishka   379 Aug 28 07:52 p27c.c

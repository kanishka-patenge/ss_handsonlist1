...
int main()
{
    ...
    printf("Using the execv() to execute ls -Rl \n");
    char *file = "ls";
    execv(path,args);
...
kanishka@kanishka-HP-Laptop-15s-fq5xxx:~/abc$ gcc p27d.c
kanishka@kanishka-HP-Laptop-15s-fq5xxx:~/abc$ ./a.out
Using the execv() to execute ls -Rl 
.:
total 580
...
-rwxrwxr-x 1 kanishka kanishka 16056 Aug 29 19:37 a.out
...
-rw-rw-r-- 1 kanishka kanishka   800 Aug 29 19:37 p27d.c

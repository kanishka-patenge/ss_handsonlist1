...
kanishka@kanishka-HP-Laptop-15s-fq5xxx:~/abc$ gcc p27b.c
kanishka@kanishka-HP-Laptop-15s-fq5xxx:~/abc$ ./a.out
Using the execlp() to execute ls -Rl 
.:
total 572
...
-rwxrwxr-x 1 kanishka kanishka 16000 Aug 29 19:34 a.out
...
-rw-rw-r-- 1 kanishka kanishka   777 Aug 29 19:33 p27b.c
